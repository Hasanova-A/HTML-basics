...
Salam! Bu repository-də front-end sahəsinə giriş edərkən və veb-in təməl prinsiplərini öyrənərkən yazdığım praktiki HTML/CSS kodlarımı toplamışam. Məqsədim veb-səhifələrin strukturunu düzgün qurmaq, semantik etiketləri anlamaq və onları tətbiq etmək olub.

## 🛠 İstifadə olunan texnologiyalar
- **HTML5:** Səhifə strukturu, media elementləri və semantik karkasın qurulması üçün.
- **CSS3:** Elementlərin rəngləndirilməsi və ilkin stilləndirmə işləri üçün.
...
## 💡 Niyə bu repository?
Gələcəkdə React kimi modern kitabxanalarla və ya daha mürəkkəb arxitekturalarla işlədikcə, hər şeyin təməlinin təmiz və düzgün HTML yazmaqdan keçdiyini bilirəm. Bu kiçik layihələr həmin möhkəm təməli necə formalaşdırdığımın bir göstəricisidir.
